    ...
    return (
      <div
        ...
        className={cn(
          ...
          "h-[100px] p-1 flex items-center rounded-xl relative",
          className,
          isSelected ? "bg-muted" : ""
        )}
        {...props}
      >
        <div className="font-medium leading-none tracking-tight flex items-center gap-1.5 h-full w-full overflow-hidden rounded-xl">
          {children}
        </div>
        <button
          type="button"
        ...
        >
          ...
          <RemoveIcon className="w-5 h-5 cursor-pointer text-white hover:stroke-destructive duration-200 ease-in-out" />
        </button>
      </div>
    );
  }
